...
class News{
  ...
  Future<void> getNews()async{
    ...
    String url1 = "https://newsapi.org/v2/everything?&apiKey=57ee8c828be84296ba105eb0b4e61e48";
...
class CategoryNewsClass{
  ...
  Future<void> getNews(String category)async{
    //var response = await http.get(uri);
    http.Response response = await http.get(Uri.parse('https://newsapi.org/v2/top-headlines?category=$category&country=us&apiKey=57ee8c828be84296ba105eb0b4e61e48'));
    print (response);
